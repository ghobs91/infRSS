...
"[project]/src/lib/feedSuggestions.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    "suggestFeedsByTopic": (()=>suggestFeedsByTopic)
});
const PRIMARY_SOURCE_FEEDS = [
    {
        title: "Paul Graham's Essays",
        url: "http://www.aaronsw.com/2002/feeds/pgessays.rss"
    },
    {
        title: "Steve Yegge's Blog",
    ...
    },
    {
        ...
        url: "https://gvanrossum.github.io/feed.xml"
    }
];
...
async function suggestFeedsByTopic(topic) {
    // ⛔ dynamic import ensures it's only run in the browser
    const { pipeline, env } = await __turbopack_context__.r("[externals]/@xenova/transformers [external] (@xenova/transformers, esm_import, async loader)")(__turbopack_context__.i);
    env.backends.onnx = "wasm";
    env.allowLocalModels = false;
    env.useBrowserCache = true;
    const embedder = await pipeline("feature-extraction", "Xenova/all-MiniLM-L6-v2");
    const topicEmbedding = (await embedder(topic))[0][0];
    const scored = await Promise.all(PRIMARY_SOURCE_FEEDS.map(async (feed)=>{
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$feedSuggestions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/feedSuggestions.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function HomePage() {
    ...
    const handleTopicSuggest = async ()=>{
        const results = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$feedSuggestions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["suggestFeedsByTopic"])(topic);
        setSuggestedFeeds(results);
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        className: "p-6 space-y-6 max-w-3xl mx-auto bg-gray-900 text-gray-100 min-h-screen",
        children: [
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardContent"], {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                            href: article.link,
                                            className: "text-lg font-medium underline text-blue-400",
...
//# sourceMappingURL=_dcef91c1._.js.map