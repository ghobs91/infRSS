...
const secureHttpsAgent = new __TURBOPACK__imported__module__$5b$externals$5d2f$https__$5b$external$5d$__$28$https$2c$__cjs$29$__["Agent"]({
...
const insecureHttpsAgent = new __TURBOPACK__imported__module__$5b$externals$5d2f$https__$5b$external$5d$__$28$https$2c$__cjs$29$__["Agent"]({
    rejectUnauthorized: false,
    keepAlive: true,
    timeout: TIMEOUT
});
// Helper function to determine if a URL should use insecure connection
function shouldUseInsecureConnection(url) {
    try {
...
async function fetchWithTimeout(url, timeout = TIMEOUT, retries = 2) {
    ...
    try {
        ...
        const agent = url.startsWith('https') ? useInsecure ? insecureHttpsAgent : secureHttpsAgent : undefined;
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__23cc4dc3._.js.map