(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_3525d30f._.js", {
...
"[project]/src/lib/feedSuggestions.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function suggestFeedsByTopic(topic) {
    ...
    const { pipeline, env } = await __turbopack_context__.r("[project]/node_modules/@xenova/transformers/src/transformers.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$feedSuggestions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/feedSuggestions.ts [app-client] (ecmascript)");
;
...
function HomePage() {
    ...
    const handleTopicSuggest = async ()=>{
        const results = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$feedSuggestions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["suggestFeedsByTopic"])(topic);
...
_s(HomePage, "/A4sH5na4KbkDSGSHoRqZbg50kw=");
_c = HomePage;
var _c;
...
//# sourceMappingURL=_3525d30f._.js.map