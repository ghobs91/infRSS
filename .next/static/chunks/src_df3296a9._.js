(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_df3296a9._.js", {
    ...
    const handleAddFeed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ManagePage.useCallback[handleAddFeed]": async ()=>{
            ...
            try {
                ...
                let feedData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rssUtilsClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchAndParseRSSClient"])(feedUrlInput.trim(), parseRSSWithWorker);
                // If that fails, try to extract the feed URL from the HTML
                let discoveredFeedUrl = null;
                if (!feedData) {
                    discoveredFeedUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rssUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getFeedUrlFromHtml"])(feedUrlInput.trim());
                    if (discoveredFeedUrl) {
                        feedData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rssUtilsClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchAndParseRSSClient"])(discoveredFeedUrl, parseRSSWithWorker);
                    }
                }
                // If still no feed, try advanced discovery
                if (!feedData) {
                    discoveredFeedUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rssUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["discoverFeedUrlWithFallbacks"])(feedUrlInput.trim());
                    if (discoveredFeedUrl) {
                        feedData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rssUtilsClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchAndParseRSSClient"])(discoveredFeedUrl, parseRSSWithWorker);
                    }
                }
...
_s3(ManagePage, "gvxfXawZJkS2Yr3tYwN190jI7Wo=", false, function() {
    return [
...
//# sourceMappingURL=src_df3296a9._.js.map