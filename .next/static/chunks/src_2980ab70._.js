(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_2980ab70._.js", {
...
const Article = ({ article, onVisible })=>{
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Article.useEffect": ()=>{
            ...
            return ({
                "Article.useEffect": ()=>observer.disconnect()
            })["Article.useEffect"];
        }
    }["Article.useEffect"], [
        onVisible
...
_s(Article, "9xbJkaDmDEtmLkNW+zDixtiSXnA=");
_c = Article;
function HomePage() {
    _s1();
...
_s1(HomePage, "6sadVsssIfLcTTqP9/vllJduswA=", false, function() {
    return [
...
//# sourceMappingURL=src_2980ab70._.js.map